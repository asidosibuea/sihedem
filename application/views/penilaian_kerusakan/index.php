    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
            	...
            	<div class="box-tools">
                    <a href="<?php echo site_url('penilaian_kerusakan/add'); ?>" class="btn btn-success btn-sm">Add</a> 
                </div>
            </div>
                ...
                <table class="table table-striped">
                    ...
                    <tr>
						...
						<td>
                            ...
                            <a href="<?php echo site_url('penilaian_kerusakan/remove/'.$p['ID_PENILAIAN']); ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Delete</a>
						</td>
                    </tr>
                    <?php } ?>
                </table>
